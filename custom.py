...
def insert_styling(bgr: int, bgg: int, bgb: int, bgAlpha: int, sbr: int, sbg: int, sbb: int, sbAlpha: int, text_color: str = 'black') -> None: 
    """
