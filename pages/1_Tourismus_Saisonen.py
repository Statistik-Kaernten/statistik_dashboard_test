...
from map import create_static_map, create_interactive_map
...
with st.sidebar:
    ...
    if region != 'Ganz Kärnten':
        streamlit_bokeh(create_static_map(gkzList=[str(i) for i in getGkz('Tourismusregion', region)], bg_color='#46c39f'), use_container_width=False)
    #else:
    #    streamlit_bokeh(create_static_map(gkzList=[str(gkz) for gkz in getSelectionItems()['Gkz']], bg_color='#46c39f'), use_container_width=True)
